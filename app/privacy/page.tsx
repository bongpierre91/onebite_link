...
const OPERATOR_NAME = "봉대순";
const CONTACT_EMAIL = "daesoonb@gmail.com";
    ...
    <main className="mx-auto max-w-3xl px-6 py-12 text-gray-800">
      ...
      >
        ...
        <ol className="list-decimal space-y-1 pl-5 text-sm text-gray-700">
          <li><a href="#s1" className="hover:underline">개인정보의 처리 목적</a></li>
          <li><a href="#s2" className="hover:underline">처리하는 개인정보의 항목</a></li>
          <li><a href="#s3" className="hover:underline">개인정보의 처리 및 보유 기간</a></li>
          <li><a href="#s4" className="hover:underline">개인정보의 파기 절차 및 방법</a></li>
          <li><a href="#s5" className="hover:underline">개인정보 처리업무의 위탁</a></li>
          <li><a href="#s6" className="hover:underline">정보주체의 권리·의무 및 행사방법</a></li>
          <li><a href="#s7" className="hover:underline">개인정보의 안전성 확보 조치</a></li>
          <li><a href="#s8" className="hover:underline">쿠키 운영 및 거부 방법</a></li>
          <li><a href="#s9" className="hover:underline">개인정보 보호책임자</a></li>
          <li><a href="#s10" className="hover:underline">권익침해 구제방법</a></li>
          <li><a href="#s11" className="hover:underline">처리방침의 변경</a></li>
        </ol>
      </nav>
      ...
      <section id="s3" className="mb-10 scroll-mt-20">
        <h2 className="mb-4 text-xl font-bold">3. 개인정보의 처리 및 보유 기간</h2>
      ...
      <section id="s4" className="mb-10 scroll-mt-20">
        <h2 className="mb-4 text-xl font-bold">4. 개인정보의 파기 절차 및 방법</h2>
        <p className="mb-3 leading-relaxed">
          ...
          <table className="w-full border-collapse border text-sm">
            ...
            <tbody>
              <tr>
                ...
                <td className="border px-3 py-2">회원 정보 저장 및 인증 처리, 데이터베이스 운영</td>
                <td className="border px-3 py-2">대한민국 (Seoul 리전)</td>
                <td className="border px-3 py-2">회원 탈퇴 또는 위탁계약 종료 시까지</td>
              </tr>
              <tr>
      ...
      <section id="s6" className="mb-10 scroll-mt-20">
        <h2 className="mb-4 text-xl font-bold">6. 정보주체의 권리·의무 및 행사방법</h2>
        <p className="mb-3 leading-relaxed">
      ...
      <section id="s7" className="mb-10 scroll-mt-20">
        <h2 className="mb-4 text-xl font-bold">7. 개인정보의 안전성 확보 조치</h2>
        <ul className="list-disc space-y-2 pl-6 leading-relaxed">
          <li>
      ...
      <section id="s10" className="mb-10 scroll-mt-20">
        ...
        <ul className="list-disc space-y-1 pl-6 leading-relaxed">
          <li>
            ...
            <a href="https://www.kopico.go.kr" target="_blank" rel="noreferrer noopener" className="text-blue-600 underline">
              www.kopico.go.kr
            </a>
            )
          </li>
          <li>
            개인정보침해신고센터: (국번없이) 118 (
            <a href="https://privacy.kisa.or.kr" target="_blank" rel="noreferrer noopener" className="text-blue-600 underline">
              privacy.kisa.or.kr
            </a>
            )
          </li>
          <li>
            대검찰청: (국번없이) 1301 (
            <a href="https://www.spo.go.kr" target="_blank" rel="noreferrer noopener" className="text-blue-600 underline">
              www.spo.go.kr
            </a>
            )
          </li>
          <li>
            경찰청: (국번없이) 182 (
            <a href="https://ecrm.cyber.go.kr" target="_blank" rel="noreferrer noopener" className="text-blue-600 underline">
              ecrm.cyber.go.kr
            </a>
            )
          </li>
